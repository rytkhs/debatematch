        ...
        <div class="max-w-3xl mx-auto px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ __('errors.error_429_title') }}</h1>
                    <p class="text-lg text-gray-600">{{ __('errors.error_429_message') }}</p>
                </div>
                <div class="text-center mt-8">
                    <p class="text-gray-600 mb-6">{{ __('errors.error_429_action') }}</p>
