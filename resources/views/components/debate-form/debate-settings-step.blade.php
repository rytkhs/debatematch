            ...
            <div class="grid grid-cols-2 gap-3 sm:gap-4">
                <label class="relative flex bg-green-50 p-3 sm:p-4 rounded-lg border border-green-200 cursor-pointer hover:bg-green-100 transition-all duration-200 hover:shadow-md">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <span class="block text-xs sm:text-sm font-medium text-green-800">{{ __('messages.affirmative_side') }}</span>
                            <span class="text-xs text-green-600">{{ __('messages.agree_with_topic') }}</span>
                        </div>
                    </div>
                </label>
                ...
                <label class="relative flex bg-red-50 p-3 sm:p-4 rounded-lg border border-red-200 cursor-pointer hover:bg-red-100 transition-all duration-200 hover:shadow-md">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            <span class="block text-xs sm:text-sm font-medium text-red-800">{{ __('messages.negative_side') }}</span>
                            <span class="text-xs text-red-600">{{ __('messages.disagree_with_topic') }}</span>
                        </div>
                    </div>
                </label>
            </div>
        ...
        <div class="md:col-span-2 required-field">
            ...
            <div class="mb-4">
                <button type="button" class="flex items-center text-xs text-blue-600 hover:text-blue-800 transition-colors" onclick="toggleFormatHelp()">
                    ...
                    <span>{{ __('messages.format_selection_help') }}</span>
                ...
                <div id="format-help-content" class="hidden mt-2 p-3 bg-blue-50 border-l-4 border-blue-400 rounded-md">
                    <ul class="list-disc list-inside text-xs text-blue-700 space-y-1">
                        <li><strong>{{ __('messages.competition_format') }}：</strong>{{ __('messages.competition_format_help') }}</li>
                        <li><strong>{{ __('messages.custom_format') }}：</strong>{{ __('messages.custom_format_help') }}</li>
                        <li><strong>{{ __('debates.format_name_free') }}：</strong>{{ __('messages.free_format_help') }}</li>
                    </ul>
                    <p class="mt-2 text-xs text-blue-600">
                        <a href="{{ route('guide') }}#debate-formats" class="underline hover:text-blue-800 transition-colors">
                            {{ __('messages.view_detailed_guide') }}
                        </a>
                    </p>
                </div>
            </div>
            ...
            <div class="space-y-3">
                    ...
                    <div class="ml-3 flex-1">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <span class="text-xs sm:text-sm font-medium text-blue-800">{{ __('messages.competition_format') }}</span>
                            </div>
                        </div>
                        <p class="text-xs text-blue-700 mt-1">{{ __('messages.competition_format_description') }}</p>
                    ...
                    <div class="ml-3 flex-1">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <span class="text-xs sm:text-sm font-medium text-amber-800">{{ __('messages.custom_format') }}</span>
                            </div>
                        </div>
                        <p class="text-xs text-amber-700 mt-1">{{ __('messages.custom_format_description') }}</p>
                    </div>
                </label>
                ...
                <label class="relative flex items-center bg-green-50 p-3 sm:p-4 rounded-lg border border-green-200 cursor-pointer hover:bg-green-100 transition-all duration-200 group hover:shadow-md">
                    ...
                    <div class="ml-3 flex-1">
                        ...
                        <p class="text-xs text-green-700 mt-1">{{ __('messages.free_format_short_description') }}</p>
                    </div>
                </label>
            </div>
