<div x-data="{ show: true }"
    ...
    @if (session('success'))
        <div class="flex items-center p-4 mb-4 text-white bg-emerald-500 rounded-lg shadow-md">
            ...
            <button type="button" @click="show = false" class="ml-auto -mx-1.5 -my-1.5 text-white hover:text-white focus:ring-2 focus:ring-emerald-400 p-1.5 inline-flex h-8 w-8 rounded-lg">
    ...
    @if (session('error'))
        <div class="flex items-center p-4 mb-4 text-white bg-red-500 rounded-lg shadow-md">
            ...
            <button type="button" @click="show = false" class="ml-auto -mx-1.5 -my-1.5 text-white hover:text-white focus:ring-2 focus:ring-red-400 p-1.5 inline-flex h-8 w-8 rounded-lg">
                <span class="sr-only">閉じる</span>
                <i class="fa-solid fa-xmark"></i>
            </button>
        </div>
    ...
    @if (session('info'))
        <div class="flex items-center p-4 mb-4 text-white bg-sky-600 rounded-lg shadow-md">
            ...
            <button type="button" @click="show = false" class="ml-auto -mx-1.5 -my-1.5 text-white hover:text-white focus:ring-2 focus:ring-blue-400 p-1.5 inline-flex h-8 w-8 rounded-lg">
                <span class="sr-only">閉じる</span>
                <i class="fa-solid fa-xmark"></i>
            </button>
        </div>
    ...
    @if (session('warning'))
        <div class="flex items-center p-4 mb-4 text-white bg-yellow-500 rounded-lg shadow-md">
            ...
            <button type="button" @click="show = false" class="ml-auto -mx-1.5 -my-1.5 text-white hover:text-white focus:ring-2 focus:ring-yellow-400 p-1.5 inline-flex h-8 w-8 rounded-lg">
                <span class="sr-only">閉じる</span>
                <i class="fa-solid fa-xmark"></i>
            </button>
        </div>
