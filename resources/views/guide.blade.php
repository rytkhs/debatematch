<x-app-layout>
    ...
    <div class="bg-white pt-12 sm:pt-16 pb-8 sm:pb-12">
        <div class="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            {{-- ページタイトル --}}
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-3 sm:mb-4">DebateMatch 使い方ガイド</h1>
            {{-- ページ概要説明 --}}
    ...
    <section class="py-12 sm:py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-900 text-center mb-8 sm:mb-12">主な機能</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
                ...
                <div class="feature-card bg-white p-4 sm:p-6 rounded-lg shadow-sm text-center">
                    <div class="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-primary-light flex items-center justify-center mb-3 sm:mb-5 mx-auto">
                        <span class="material-icons text-primary text-2xl sm:text-3xl">meeting_room</span>
                    </div>
                    <h3 class="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-900">ルーム管理</h3>
                    <p class="text-xs sm:text-sm text-gray-600">ディベートルームを自由に作成・検索し、他のユーザーとマッチングできます。</p>
                </div>
                {{-- 機能カード: リアルタイムチャット --}}
                <div class="feature-card bg-white p-4 sm:p-6 rounded-lg shadow-sm text-center">
                    <div class="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-primary-light flex items-center justify-center mb-3 sm:mb-5 mx-auto">
                    ...
                    <h3 class="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-900">リアルタイムチャット</h3>
                    <p class="text-xs sm:text-sm text-gray-600">テキストベースのチャットで、スムーズなディベート進行を実現します。</p>
                </div>
                {{-- 機能カード: 自動進行 & タイマー --}}
                <div class="feature-card bg-white p-4 sm:p-6 rounded-lg shadow-sm text-center">
                     <div class="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-primary-light flex items-center justify-center mb-3 sm:mb-5 mx-auto">
                    ...
                    <h3 class="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-900">自動進行 & タイマー</h3>
                    <p class="text-xs sm:text-sm text-gray-600">設定されたフォーマットに基づき、タイマーと進行が自動で管理されます。</p>
                </div>
                {{-- 機能カード: AIによる講評 --}}
                 <div class="feature-card bg-white p-4 sm:p-6 rounded-lg shadow-sm text-center">
                    <div class="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-primary-light flex items-center justify-center mb-3 sm:mb-5 mx-auto">
                    ...
                    <h3 class="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-900">AIによる講評</h3>
                    <p class="text-xs sm:text-sm text-gray-600">ディベート終了後、AIが議論を分析し、勝敗判定と詳細なフィードバックを提供します。</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 sm:py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-900 text-center mb-8 sm:mb-12">ディベートの流れ</h2>
            <div class="space-y-8 sm:space-y-12">
                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4 sm:gap-8">
                        ...
                        <div class="guide-step bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200">
                            <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">1. ユーザー登録・ログイン</h4>
                            <p class="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-4">初めての方は<a href="{{ route('register') }}" class="text-primary hover:underline">新規登録</a>からアカウントを作成してください。登録済みの方は<a href="{{ route('login') }}" class="text-primary hover:underline">ログイン</a>してください。</p>
                            <p class="text-xs sm:text-sm text-gray-600">メール認証が必要な場合があります。</p>
                        </div>
                        {{-- 準備ステップ2: ルームを探す or 作成する --}}
                        <div class="guide-step bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200">
                            <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">2. ルームを探す or 作成する</h4>
                            ...
                            <p class="text-xs sm:text-sm text-gray-600">ルーム作成時には、論題、ルーム名、備考、使用言語、ディベートフォーマットを選択します。カスタムフォーマットも設定可能です。</p>
                        </div>
                    </div>
                </div>
                ...
                {{-- ステップ 2: マッチング --}}
                 <div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4 sm:gap-8">
                        {{-- マッチングステップ1: ルームに参加する --}}
                        <div class="guide-step bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200">
                             <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">3. ルームに参加する</h4>
                            <p class="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-4">参加したいルームを見つけたら、ルーム詳細ページで「肯定側」または「否定側」のどちらで参加するかを選択し、参加ボタンを押します。</p>
                            <p class="text-xs sm:text-sm text-gray-600">既に他のユーザーが参加しているサイドには参加できません。</p>
                        </div>
                        {{-- マッチングステップ2: 待機と開始 --}}
                        <div class="guide-step bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200">
                            <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">4. 待機と開始</h4>
                             <p class="text-xs sm:text-sm text-gray-600 mb-2">ルームに参加すると待機画面に移ります。肯定側・否定側の両方のプレイヤーが揃うと、ルーム作成者（ホスト）がディベートを開始できます。</p>
                            <p class="text-xs sm:text-sm text-gray-600">準備ができたら、ホストは「ディベート開始」ボタンを押してください。</p>
                         </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="guide-step bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200 mb-4 sm:mb-8">
                        <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">5. ディベート画面の見方と操作</h4>
                ...
                <div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4 sm:gap-8">
                        {{-- 講評テップ1: ディベート終了とAI講評 --}}
                        <div class="guide-step bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200">
                            <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">6. ディベート終了とAI講評</h4>
                             <p class="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-4">最後のパートが終了すると、ディベートは自動的に完了します。その後、AIによる評価がバックグラウンドで開始されます。</p>
                             <p class="text-xs sm:text-sm text-gray-600">評価には数十秒〜数分程度かかる場合があります。評価が完了すると、結果ページへ自動的にリダイレクトされるか、通知が表示されます。</p>
                         </div>
                         {{-- 講評ステップ2: 結果の確認 --}}
                         <div class="guide-step bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200">
                            <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">7. 結果の確認</h4>
                            <p class="text-xs sm:text-sm text-gray-600 mb-2">結果ページでは、AIによる以下の講評を確認できます。</p>
                            ...
                            <p class="text-xs sm:text-sm text-gray-600 mt-2">タブを切り替えることで、ディベート中のチャットログも確認できます。</p>
                        </div>
                         {{-- 講評ステップ3: ディベート履歴の確認 --}}
                         <div class="guide-step bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200 md:col-span-2">
                             <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">8. ディベート履歴の確認</h4>
                             <p class="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-4">ナビゲーションメニューの<a href="{{ route('records.index') }}" class="text-primary hover:underline">ディベート履歴</a>から、過去に参加したディベートの結果と内容を確認できます。</p>
                             <p class="text-xs sm:text-sm text-gray-600">フィルターやソート機能を使って、特定のディベートを探すことも可能です。</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-12 sm:py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-900 text-center mb-8 sm:mb-12">ディベートフォーマット</h2>
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-200">
                <p class="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">DebateMatchでは、主要なディベート大会の公式ルールに基づいたフォーマットを複数用意しています。ルーム作成時に、希望のフォーマットを選択してください。</p>
                <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">現在利用可能なフォーマット</h4>
                ...
                <h4 class="text-base sm:text-lg font-medium mb-2 sm:mb-3">カスタムフォーマット</h4>
                <p class="text-xs sm:text-sm text-gray-600">上記の既存フォーマット以外に、自分でパート構成（話者、名称、時間など）を自由に設定できる「カスタム」フォーマットも利用可能です。ルーム作成時に「カスタム」を選択し、詳細を設定してください。</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 sm:py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-900 text-center mb-8 sm:mb-12">よくある質問</h2>
            <div class="space-y-4 sm:space-y-6">
                {{-- FAQ項目1 --}}
                <div x-data="{ open: false }" class="border border-gray-200 rounded-lg overflow-hidden">
                    <button @click="open = !open" class="flex justify-between items-center w-full px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg font-medium text-left text-gray-900 bg-white hover:bg-gray-50 focus:outline-none">
                        <span>ディベート経験がなくても参加できますか？</span>
                        <svg class="w-4 h-4 sm:w-5 sm:h-5 text-primary transition-transform duration-200" :class="{'rotate-180': open}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                        </svg>
                    </button>
                    <div x-show="open" x-transition.duration.300ms class="px-4 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-gray-600 bg-gray-50">
