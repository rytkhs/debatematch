<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
                            type="password"
                            name="password"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200"
                            type="password"
        ...
        <div class="mt-6 text-center dark:text-gray-200">
            すでにアカウントをお持ちですか？ <a href="{{ route('login') }}" class="text-teal-600 hover:text-teal-500 dark:text-teal-400 dark:hover:text-teal-300">{{ __('ログイン') }}</a>
        </div>
