<div>
    ...
    <div
        ...
        <div class="bg-white rounded-lg p-8 max-w-md w-full shadow-xl">
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">{{ __('messages.network_disconnected') }}</h3>
    ...
    <div
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="font-bold">{{ __('messages.peer_connection_unstable') }}</p>
                <p>{{ __('messages.waiting_for_reconnection') }}</p>
            </div>
