    ...
    <div class="min-h-screen bg-gray-50 py-8 sm:py-12">
        <div class="max-w-4xl mx-auto px-6 sm:px-8 lg:px-10 leading-tight text-gray-600 prose prose-xs font-serif">
            @php
                ...
                $markdownPath = resource_path("markdown/{$locale}/privacy.md");
                $fallbackLocale = 'en';
                $fallbackPath = resource_path("markdown/{$fallbackLocale}/privacy.md");
            ...
            @else
                ...
                <p class="text-red-500">Privacy policy content is currently unavailable.</p>
            @endif
        </div>
    </div>
