            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="flex items-center gap-6 mb-3">
                    <div class="flex items-center">
                        <span class="text-xs text-gray-500 mr-2">{{ __('messages.you') }}:</span>
                        <span class="inline-flex items-center text-sm font-medium {{ $sideClass }}">
                            {{ $side }}
                        </span>
                    </div>
                    <div class="flex items-center">
                        <span class="text-xs text-gray-500 mr-2">{{ __('messages.opponent') }}:</span>
                ...
                @if($debate->evaluations)
                    <div class="bg-blue-50 rounded-lg p-3 border-l-4 border-blue-400">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-xs font-medium text-blue-800 mb-1">{{ __('messages.ai_evaluation') }}</p>
