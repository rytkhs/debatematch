...
return [
    ...
    */
    ...
    'faq1_answer' => 'はい、大歓迎です！ DebateMatchは、ディベート経験がない方でも気軽に参加できます。AIによるフィードバック機能も、スキルアップの助けになります。まずは<a href=":url" class="text-primary hover:underline">使い方ガイド</a>をご覧になり、簡単なルームから参加してみることをお勧めします。',
    'usage_guide' => '使い方ガイド',
