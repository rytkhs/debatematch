...
return [
    ...
    'welcome_description' => 'DebateMatch(ディベートマッチ)は、誰でも簡単に参加できるオンラインディベートプラットフォームです。意見を交わし、新
    しい視点を見つけましょう。',
    'search_room' => 'ルームを探す',
    'features_title' => 'DebateMatchの特徴',
    'realtime_chat' => 'リアルタイムチャット',
    'realtime_chat_description' => '場所や時間に縛られることなく、いつでもどこでもディベーターとマッチング。すぐにディベートを始めることができま
    す。',
    ...
    'ai_feedback_description' => 'ディベート終了後、AIジャッジが議論を分析。勝敗判定と詳細な講評を提供します。具体的な改善点もフィードバックしま
    す。',
    'how_to_use' => '使い方',
    ...
    'faq1_answer' => 'はい、大歓迎です！ DebateMatchは、ディベート経験がない方でも気軽に参加し、楽しみながら学べるように設計されています。AIによ
    るフィードバック機能も、スキルアップの助けになります。まずは<a href=":url" class="text-primary hover:underline">使い方ガイド</a>をご覧にな
    り、簡単なルームから参加してみることをお勧めします。',
    'usage_guide' => '使い方ガイド',
    'faq2_question' => '利用料金はかかりますか？',
    'faq2_answer' => '現在、DebateMatchのすべての機能を無料でご利用いただけます。アカウント登録も無料です。',
    'faq3_question' => 'ディベートに参加するために必要なものは何ですか？',
    'faq3_answer' => 'インターネットに接続されたパソコンやタブレット、スマートフォンと、最新版のウェブブラウザ（Google Chrome, Firefox,
    Safari, Edgeなど）があれば参加できます。特別なソフトウェアのインストールは不要です。安定したディベートのためには、Wi-Fiなどの安定したネットワー
    ク環境を推奨します。',
    'faq4_question' => 'スマートフォンやタブレットでも利用できますか？',
    'faq4_answer' => 'はい、スマートフォンやタブレットでもご利用いただけます。ただし、ディベート中は多くの情報を表示するため、より快適にご利用いた
    だくためには、画面の大きいパソコンやタブレットでの利用を推奨します。',
    'faq5_question' => 'AIフィードバックとは具体的にどのようなものですか？',
    'faq5_answer' => 'ディベート終了後、AIが議論全体の内容を分析します。公平な視点から勝敗を判定し、その理由を説明します。さらに、肯定側・否定側そ
    れぞれに対し、議論の良かった点や改善すべき点を具体的に指摘するフィードバックを提供します。これにより、客観的な視点から自身のディベートスキルを振り
    返り、向上させることができます。',
    ...
    'prep_step2_desc2' => 'ルーム作成時には、論題、ルーム名、備考、使用言語、ディベートフォーマットを選択します。カスタムフォーマットも設定可能で
    す。',
    'step2_matching' => 'ステップ2：マッチング',
    'match_step1_title' => '3. ルームに参加する',
    'match_step1_desc1' => '参加したいルームを見つけたら、ルーム詳細ページで「肯定側」または「否定側」のどちらで参加するかを選択し、参加ボタンを押
    します。',
    'match_step1_desc2' => '既に他のユーザーが参加しているサイドには参加できません。',
    'match_step2_title' => '4. 待機と開始',
    'match_step2_desc1' => 'ルームに参加すると待機画面に移ります。肯定側・否定側の両方のプレイヤーが揃うと、ルーム作成者（ホスト）がディベートを開
    始できます。',
    ...
    'critique_step1_desc2' => '評価には数十秒〜数分程度かかる場合があります。評価が完了すると、結果ページへ自動的にリダイレクトされるか、通知が表
    示されます。',
    ...
    'faq_guide1_a' => 'はい、大歓迎です！ DebateMatchは、ディベート経験がない方でも気軽に参加し、楽しみながら学べるように設計されています。AIによ
