...
return [
    ...
    */
    ...
    'openrouter' => [
        ...
        'topic_generator_timeout' => env('OPENROUTER_TOPIC_GENERATOR_TIMEOUT', 60),
        'topic_generator_temperature' => env('OPENROUTER_TOPIC_GENERATOR_TEMPERATURE', 0.8),
        'topic_generator_max_tokens' => env('OPENROUTER_TOPIC_GENERATOR_MAX_TOKENS', 2000),
